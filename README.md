...
10. Configure the FAQ link, newsletter copy, main footer logo, repeatable partner-logo columns, and social URLs under **Appearance → Footer Settings**. Footer logos come from the WordPress Media Library and should include meaningful alternative text.
...
├── blocks/                   # Dynamic ACF blocks and their block.json metadata
├── inc/
